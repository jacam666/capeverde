...
//                                     width="60%"
//                                     alt={item.title}
//                                     className="image-team w-full object-cover rounded-full opacity-100"
//                                     src={item.img}
//                                 />
                        ...
                        <CardBody className="h-auto p-0 m-2 mb-5">
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                                <Image
                                    ...
                                    width="60%"
                                    alt={item.title}
                                    className="w-full object-cover rounded-full image-team opacity-100"
                                    src={item.img}
                                />
                                <div className="text-center text-gray-800 text-4xl mt-3">{item.title}</div>
                            </div>
            ...
            <div className="">
                ...
                <div>
                    <div className="grid sm:grid-cols-2 xl:grid-cols-4 gap-1">
                        {[
                            { name: "Melissa", img: "/images/volunteer1.jpg" },
                            { name: "Djack", img: "/images/volunteer2.jpg" },
                            { name: "Paulo", img: "/images/volunteer3.jpg" },
                            { name: "Ivan", img: "/images/volunteer4.jpg" },
                            { name: "Solange", img: "/images/volunteer5_edited.jpg" },
                            { name: "Fernanda", img: "/images/volunteer6.jpg" },
                            { name: "Ivania", img: "/images/volunteer7.jpg" },
                            { name: "Marco", img: "/images/volunteer8.jpg" },
                            { name: "Fortunato", img: "/images/volunteer9.jpg" },
                        ].map((volunteer, index) => (
                            <div key={index} className="my-3 mx-2">
                                <img
                                    className="image-team rounded-full w-3/5 mx-auto"
                                    src={volunteer.img}
                                    alt={`volunteer-${index + 1}`}
                                />
                                <h2 className="text-center text-gray-800 text-4xl my-4">{volunteer.name}</h2>
                            </div>
                        ))}
                    </div>
                </div>
