  ...
  return (
    <div className=' bg-gradient-to-r from-blue-100 to-slate-600' style={{ minHeight: '100vh' }}>
      ...
      <div className="w-full" >
        <img src="/images/WhatsApp Image 2024-04-27 at 17.10.27_0fadff63.jpg" alt="verde" style={{ width: '100%'}} />
      </div>
      ...
      <div className="w-full" >
        <img src="/images/WhatsApp Image 2024-04-27 at 17.10.27_34eda20e.jpg" alt="verde" style={{ width: '100%'}} />
      </div> 
    </div>
  );
}
