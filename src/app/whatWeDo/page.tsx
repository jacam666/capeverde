    ...
    return (
        <div className='' >
            ...
            <div className='mx-4 rounded-lg text-center py-9 '>
                <h1 className='homepage-header text-6xl sm:text-7xl text-gray-900 mt-8 mb-6'>What we do</h1>
                <div className='  py-3 mx-3 mb-3'>
                    <div className='px-3 text-black text-center'>
                        <p className='homepage-header text-xl w-3/4 md:text-3xl mx-auto md:p-5 '>
                ...
                <div className=" h-1 sm:h-1 w-1/2 md:w-2/5 bg-black mx-auto mt-4 "></div>

                <div className='  py-2 mx-3 mb-3'>
                    <div className='px-3 my-6 text-black text-xl text-center'>
                        <p className='homepage-header text-xl w-5/6 md:text-3xl mx-auto md:p-5'>
                ...
                <div className=" h-1 sm:h-1 w-1/2 lg:w-2/5 md:w-2/5 bg-black mx-auto mt-4"></div>

                <div className='  py-2 mx-3 mb-3'>
                    <div className='px-3 my-6 text-black text-xl text-center'>
                        <p className='homepage-header text-xl md:text-3xl w-5/6 mx-auto md:p-5'>We provide schools and children with stationery and school supplies.</p>
                        <div className="grid grid-cols-2 gap-2 pt-3 ">
                            <div className="flex justify-center">
                                <div className="image-container">
                ...
                <div className='  py-2 mx-3 mb-3'>
                    <div className='text-black px-3 text-xl pt-2 text-center'>
                        ...
                        <div className="grid grid-cols-2 gap-2 pt-3">
                            ...
                            <div className="flex justify-center">
                                <div className="image-container">
                                    <img src="/images/xmasgifts1.jpg" alt="Image 2" className='w-4/5 items-center m-auto rounded' />
                                </div>
                            </div>
                        </div>
                        <p className='homepage-header text-xl md:text-3xl w-5/6 mx-auto md:p-5 lg:px-12 mt-3'>
